...
public class FactionInformation {
	...
	public static enum FACTIONINFO{
		...
		FACTIONINFO(int fID, String name, String abrv, STANDING r1, STANDING r2, STANDING r3, STANDING r4, STANDING r5, STANDING r6, STANDING r7, STANDING r8){
			this.fID = fID;
			this.name = name;
			this.abrv = abrv;
			this.repFac01 = r1;
