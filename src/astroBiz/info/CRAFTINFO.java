...
//	enumval (symbol, name, intro, retire, speed, range, capacity, fuelE, maintR, cost, col, row, description		//
	...
	CRAFTINFO(String mfg, String name, int introduced, int retired, int speed, double range, int capacity, int fuele, int maintr, int cost, int spriteCol, int spriteRow, String desc){
		this.mfg = mfg;
		this.name = name;
		this.desc = desc;
